...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="container mt-12" style="display: flex; align-items: center; justify-content: center" >
            <div class="row">
                <form name="frmLogin" action="ServletControlador.do" method="POST" onsubmit="return validar_campos()">
                     <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="txtCorreo" placeholder="Ingresa tu Correo" class="form-control">  
                            </div>  
                            </div>
                            <div class="d-flex">
                                <div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <input type="password" name="txtClave" placeholder="Clave" class="form-control">
                            </div>  
                            </div>
                        </div>
                        <div class="card-footer text-center" enctype="multipart/form-data">
                            <div>
                                ...
                                <a href="olvidoContrasena.jsp">Olvide mi contraseña</a><br>
