                    ...
                    <div class="card">
                        ...
                        <div class="card-footer text-center" enctype="multipart/form-data">
                            <div>
                                ...
                                <input type="submit" name="accion" value="Registrarse"  class="btn btn-outline-primary" ><br>
                                <input type="submit" name="accion" value="Home" class="btn btn-outline-danger"><br>
